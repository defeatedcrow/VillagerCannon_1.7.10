...
public class ItemForceRenderer implements IItemRenderer{
	
	private static final ResourceLocation resource = new ResourceLocation("villagercannon:textures/entity/villagerforce.png");
	private VillagerForceModel model = new VillagerForceModel();
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		if (canRendering(item, type))
		{
			...
			this.model.renderHead((Entity) null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
			
			GL11.glEnable(GL11.GL_BLEND);
			GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
			GL11.glColor4f(2.0F, 2.0F, 2.0F, 0.5F);
			this.model.renderCore((Entity) null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
	...
	*/
	...
	GL11.glTranslatef(0.5F, -1.125F, -0.5F);
	}
	/*
	* ドロップ状態での描画位置の調整.
	*/
